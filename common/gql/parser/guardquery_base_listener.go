...
// EnterWindowSizeStmt is called when production windowSizeStmt is entered.
func (s *BaseGuardQueryListener) EnterWindowSizeStmt(ctx *WindowSizeStmtContext) {}

// ExitWindowSizeStmt is called when production windowSizeStmt is exited.
func (s *BaseGuardQueryListener) ExitWindowSizeStmt(ctx *WindowSizeStmtContext) {}
...
func (s *BaseGuardQueryListener) EnterWindowFunction(ctx *WindowFunctionContext) {}

// ExitWindowFunction is called when production windowFunction is exited.
func (s *BaseGuardQueryListener) ExitWindowFunction(ctx *WindowFunctionContext) {}
