...
type GuardQueryListener interface {
	...
	// EnterWindowSizeStmt is called when entering the windowSizeStmt production.
	EnterWindowSizeStmt(c *WindowSizeStmtContext)
	...
	// ExitWindowSizeStmt is called when exiting the windowSizeStmt production.
	ExitWindowSizeStmt(c *WindowSizeStmtContext)
