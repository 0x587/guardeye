...
type (
	...
	HeartbeatReq         = report.HeartbeatReq
...
func (m *defaultReport) Heartbeat(ctx context.Context, in *HeartbeatReq, opts ...grpc.CallOption) (*Empty, error) {
	client := report.NewReportClient(m.cli.Conn())
