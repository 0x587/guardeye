...
type ApiClient interface {
	...
	SubscribeTopicRosout(ctx context.Context, in *Log, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Log], error)
	// topic: /v2_publisher
	PublishTopicV2Publisher(ctx context.Context, in *V2, opts ...grpc.CallOption) (*V2, error)
	SubscribeTopicV2Publisher(ctx context.Context, in *V2, opts ...grpc.CallOption) (grpc.ServerStreamingClient[V2], error)
	// topic: /parameter_events
	PublishTopicParameterEvents(ctx context.Context, in *ParameterEvent, opts ...grpc.CallOption) (*ParameterEvent, error)
	SubscribeTopicParameterEvents(ctx context.Context, in *ParameterEvent, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ParameterEvent], error)
...
func (c *apiClient) SubscribeTopicRosout(ctx context.Context, in *Log, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Log], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[0], Api_SubscribeTopicRosout_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Log, Log]{ClientStream: stream}
...
type Api_SubscribeTopicRosoutClient = grpc.ServerStreamingClient[Log]
...
func (c *apiClient) SubscribeTopicV2Publisher(ctx context.Context, in *V2, opts ...grpc.CallOption) (grpc.ServerStreamingClient[V2], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[1], Api_SubscribeTopicV2Publisher_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[V2, V2]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Api_SubscribeTopicV2PublisherClient = grpc.ServerStreamingClient[V2]
...
func (c *apiClient) SubscribeTopicParameterEvents(ctx context.Context, in *ParameterEvent, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ParameterEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[2], Api_SubscribeTopicParameterEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ParameterEvent, ParameterEvent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Api_SubscribeTopicParameterEventsClient = grpc.ServerStreamingClient[ParameterEvent]
...
type ApiServer interface {
	...
	SubscribeTopicRosout(*Log, grpc.ServerStreamingServer[Log]) error
	// topic: /v2_publisher
	PublishTopicV2Publisher(context.Context, *V2) (*V2, error)
	SubscribeTopicV2Publisher(*V2, grpc.ServerStreamingServer[V2]) error
	// topic: /parameter_events
	PublishTopicParameterEvents(context.Context, *ParameterEvent) (*ParameterEvent, error)
	SubscribeTopicParameterEvents(*ParameterEvent, grpc.ServerStreamingServer[ParameterEvent]) error
	// service: /add_two_ints_srv
...
func (UnimplementedApiServer) SubscribeTopicRosout(*Log, grpc.ServerStreamingServer[Log]) error {
...
func (UnimplementedApiServer) SubscribeTopicV2Publisher(*V2, grpc.ServerStreamingServer[V2]) error {
...
func (UnimplementedApiServer) SubscribeTopicParameterEvents(*ParameterEvent, grpc.ServerStreamingServer[ParameterEvent]) error {
...
func _Api_SubscribeTopicRosout_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ApiServer).SubscribeTopicRosout(m, &grpc.GenericServerStream[Log, Log]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Api_SubscribeTopicRosoutServer = grpc.ServerStreamingServer[Log]
...
func _Api_SubscribeTopicV2Publisher_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ApiServer).SubscribeTopicV2Publisher(m, &grpc.GenericServerStream[V2, V2]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Api_SubscribeTopicV2PublisherServer = grpc.ServerStreamingServer[V2]
...
func _Api_SubscribeTopicParameterEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ApiServer).SubscribeTopicParameterEvents(m, &grpc.GenericServerStream[ParameterEvent, ParameterEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Api_SubscribeTopicParameterEventsServer = grpc.ServerStreamingServer[ParameterEvent]
