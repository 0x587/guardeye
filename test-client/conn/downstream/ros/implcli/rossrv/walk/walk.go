...
type listener struct {
	*parser2.BaseRossrvListener
	Data map[string]any
}

func (l *listener) EnterRoot(ctx *parser2.RootContext) {
	l.Data = l.procObj(ctx.Obj())
}

func (l *listener) procEntry(entry parser2.IEntryContext) any {
	if entry.Obj() != nil {
...
func (l *listener) procObj(obj parser2.IObjContext) map[string]any {
...
func (l *listener) procList(obj parser2.IListContext) []any {
