...
var require_dist = __commonJS({
  "node_modules/@foxglove/rosmsg/dist/index.js"(exports, module2) {
    (() => {
...
// main.js
var { parse: foxglove_parse } = require_dist();
var {
  MessageReader,
  MessageWriter
} = require_dist3();
...
function read(d, v) {
  ...
  return reader.readMessage(dv);
}
function writeRos(d, v) {
...
console.log(parse, read, writeRos);
